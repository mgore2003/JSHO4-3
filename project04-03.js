...
document.getElementById("comment").addEventListener(onkeydown, updateCount());
...
function updateCount() {
   ...
   if(charCount > MAX_REVIEW) throw "You have exceeded the character count limit";
	   ...
	   document.getElementById("warningBox").innerHTML = "You have exceeded the character count limit";
   }
   finally {
	   wordCountBox.innerHTML = charCount.value;
}
}
